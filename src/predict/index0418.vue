...
<!--        <div class="predict_second_input">-->
          <input type="text" class="predict_score" v-model="score" maxlength="3" @blur="gotoBlur" @click="toggleInput" ref="scoreInput" placeholder="点击请输入成绩">
        </div>
...
<script>
  import { getYuce, getSchoolInfo, myInfo, getPaiming } from '@/api/index'
  ...
  export default {
    ...
    mounted () {
      ...
      if ('WebSocket' in window) {
        this.websocket = new WebSocket('ws://47.104.223.129:11002/cee/websocket')
        this.initWebSocket()
      } else {
