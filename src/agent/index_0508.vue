    ...
    <div class="content" ref="content">
      <div>
        ...
        <div class="agent_current" v-show="groupid !== ''">
          <p>当前代理号信息</p>
          <div class="first">当前代理号：{{groupid}}</div>
          <div class="second">
          ...
          <div class="third">
            <table style="width: 100%;text-align: center;border-collapse: collapse;">
              <caption style="margin:5px 5px 10px 5px;text-align: center">代理用户清单</caption>
              <tr class="trcontent">
                <td class="tdclass">序号</td>
                <td class="tdclass">用户微信名</td>
                <td class="tdclass">引入时间</td>
                <td class="tdclass">付费次数</td>
              </tr>
              <tr class="trcontent"
                  v-for="(item,i) in list"
              >
                <td class="tdclass">{{i}}</td>
                <td class="tdclass">{{item.username}}</td>
                <td class="tdclass">{{item.createTime | formatDate }}</td>
                <td class="tdclass">{{item.paycount}}</td>
              </tr>
            </table>
          </div>
        </div>
